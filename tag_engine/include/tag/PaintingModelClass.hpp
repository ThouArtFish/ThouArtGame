...
public:
	...
	*/
	TAGPaintingModel(const std::vector<std::string>& paths, const TAGTexLoader::Params& tex_params, const TAGResourceManager::BufferAccess& access, const TAGMesh::Material& material = {});
	/**
	...
	*/
	TAGPaintingModel(const TAGTexLoader::Params& tex_params, const TAGResourceManager::BufferAccess& access, const std::string& path = "", const TAGMesh::Material& material = {});
	/**
